...
out_dir = r"c:\Users\PC\Desktop\Waze German Voice\tools\spongebob_samples"
os.makedirs(out_dir, exist_ok=True)

queries = [
    "spongebob aushilfe gesucht",
    "spongebob pizza-heimservice",
    "spongebob heimat suesse ananas"
]
...
for i, (title, album, preview) in enumerate(all_tracks[:14]):
