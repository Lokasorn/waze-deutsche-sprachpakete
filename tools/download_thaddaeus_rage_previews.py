...
out_dir = r"c:\Users\PC\Desktop\Waze German Voice\tools\thaddaeus_samples"
...
queries = [
    ...
    "spongebob thaddaeus und der pool"
]
...
for i, (title, album, preview) in enumerate(all_tracks[:12]):
