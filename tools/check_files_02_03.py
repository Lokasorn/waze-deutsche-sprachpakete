...
r = sr.Recognizer()
wav_slice = r"c:\Users\PC\Desktop\Waze German Voice\tools\rubble_samples\slice3.wav"
...
def check_file(audio_path):
    ...
    for s in range(0, int(total_dur) - 2, 2):
...
check_file(r"c:\Users\PC\Desktop\Waze German Voice\tools\rubble_samples\03_Folge 21 Rubble der Fundhund_Kapitel 04 Rubble der Fundhund .mp3")
